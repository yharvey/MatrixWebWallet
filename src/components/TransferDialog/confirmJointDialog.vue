    ...
    <div class="content">
      ...
      <div class="info">
        <div class="transfer-item">
          <label>{{mortgageWayText}}</label>
          <label>{{mortgageWay}}</label>
        </div>
         <div class="transfer-item" v-show="mortgageWayKey==='regular'">
          <label class="from">{{timeLimitText}}</label>
          <label class="to">{{timeLimit}}</label>
        </div>
         <div class="transfer-item">
          <label class="from">{{stakeAmountText}}</label>
          <label class="to">{{amount}}<span>{{sendCoin}}</span></label>
        </div>
      </div>
      <hr class="hr-dis">
